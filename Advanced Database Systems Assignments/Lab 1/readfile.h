...
int deleteOffset2(int filehandle, int Offset);
int deleteOffset3(int filehandle, int Offset);
int searchItem(int filehandle,struct DataItem* item,int *count);
int searchItem2(int filehandle,struct DataItem* item,int *count);
int searchItem3(int filehandle,struct DataItem* item,int *count);
